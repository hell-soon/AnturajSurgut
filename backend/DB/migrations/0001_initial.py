    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FFFFFF', image_field=None, max_length=25, samples=None, verbose_name='Код')),
            ],
            options={
                'verbose_name': 'Цвет',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='product_images/', verbose_name='Загрузить картинку')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(default=0, help_text='Рейтинг товара, заполняется автоматически', verbose_name='Рейтинг')),
                ('image', models.ManyToManyField(blank=True, to='DB.productimage', verbose_name='Изображение')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='subcatalog_images/', verbose_name='Загрузить картинку')),
                ('id_1C', models.CharField(blank=True, max_length=255, null=True, verbose_name='ID 1C')),
        ...
        migrations.AddField(
            model_name='product',
            name='sub_catalog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DB.subcatalog', verbose_name='Подкаталог'),
        ),
        migrations.AddField(
            model_name='product',
            name='tags',
